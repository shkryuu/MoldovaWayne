...
<div class="row">
    <div class="col-xl-9 mx-auto">
        <h6 class="mb-0 text-uppercase">CREEAZĂ POSTAREA</h6>
        <hr/>
        <div class="card">
            <div class="card-body">
                <div class="input-group mb-3"> <span class="input-group-text" id="basic-addon1">Title</span>
                    <input type="text" class="form-control" placeholder="title" aria-label="title" value="title" aria-describedby="basic-addon1">
                </div>
