        ...
        <div class="col-lg-3 col-md-6 pb-3">
            <div class="icon-box d-flex align-items-center">
                ...
                <div class="icon-box-content ps-3">
                    <h3 class="card-title text-uppercase text-dark">Vizitați și faceți un tur</h3>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 pb-3">
            <div class="icon-box d-flex align-items-center">
                ...
                <div class="icon-box-content ps-3">
                    <h3 class="card-title text-uppercase text-dark">Rețete vechi de familie</h3>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 pb-3">
            <div class="icon-box d-flex align-items-center">
                ...
                <div class="icon-box-content ps-3">
                    <h3 class="card-title text-uppercase text-dark">Faceți placut celor dragi</h3>
                </div>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 pb-3">
