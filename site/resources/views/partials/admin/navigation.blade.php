...
<ul class="metismenu" id="menu">
    <li>
        <a href="javascript:;" class="has-arrow">
            ...
            <div class="menu-title">Panoul de control</div>
        </a>
        <ul>
            <li> <a href="/admin"><i class="bx bx-right-arrow-alt"></i>Acasă</a>
            </li>
            <li> <a href="/admin/slides/create"><i class="bx bx-right-arrow-alt"></i>Adaugă un slide</a>
            </li>
            <li> <a href="#"><i class="bx bx-right-arrow-alt"></i>Vezi slide-uri adăugate</a>
            </li>
            <li> <a href="#"><i class="bx bx-right-arrow-alt"></i>Noutăți</a>
            </li>
        </ul>
    </li>
